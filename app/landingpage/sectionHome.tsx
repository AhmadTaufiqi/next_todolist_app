            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Welcome</h1>
                        <h3 className="text-3xl"><span className="text-indigo-500">I Am</span> Ahmad Taufiqi Muhsinin</h3>
                        <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">A tech maniac and farmer.</p>
                        <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">selalu mencoba hal hal baru yang menarik bukanlah generalis tetapi bagaimana cara menjalani hidup dengan penuh ketertarikan.</p>
